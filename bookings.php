            ...
            <?php
              ...
              while($data = mysqli_fetch_assoc($result)){
                ...
                if($data['booking_status']=='booked'){
                  ...
                  if($data['arrival']==1){
                    $btn="<a href='generate_pdf.php?gen_pdf&id=$data[booking_id]' class='mt-2 btn btn-dark btn-sm shadow-none'>
                      PDF
                    </a>
                    
                    ";
                    if($data['rate_review']==0){
                      $btn.="<button  type='button' onclick='review_room($data[booking_id] , $data[room_id])' data-bs-toggle='modal' data-bs-target='#reviewModal' class='mt-2 btn btn-dark btn-sm shadow-none ms-2'>
                      Rate & Review
                    </button>";
                    }
                  } 
                  else{
                    $btn="<button type='button' onclick='cancel_booking($data[booking_id])' class='mt-2 btn btn-danger btn-sm shadow-none'>
                      Cancel
                    </button>";
                  }
                }
                ...
                <button  type='button' class='mt-2 btn btn-dark btn-sm shadow-none'>
                Rate & Review
                </button>
                ";
              }
              echo<<<bookings
                <div class='col-md-4 px-4 mb-4'>
                  <div class='bf-white p-3 rounded shadow-sm'>
                  ...
                  <div class="modal-body">
                      <div class="mb-3">
                        ...
                        <div class="mb-4">
                          ...
                          <textarea type="text" required name="review" row='3' class="form-control shadow-none"></textarea>
                        </div>
