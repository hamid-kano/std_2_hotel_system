...
<body class="bg-light">
      ...
      <div class="my-5 px-4">
        <h2 class="fw-bold f-font text-center">OUR ROOMS</h2>
        <hr>
      </div>
                                        ...
                                        <h5 class="mb-3 d-flex align-items-center justify-content-between" style="font-size:18px;">
                                          ...
                                          <div class="d-flex">
                                              <div class="me-3">
                                                ...
                                                <input type="text" min="1" id="adults" value=" <?php echo $adult_default?>" oninput="guests_filter()" class=" form-control shadow-none">
                                              </div>

                                              <div>
                                                <label class="form-label">Children</label>
                                                <input type="text" min="1" id="children" value=" <?php echo $children_default?>" oninput="guests_filter()" class=" form-control shadow-none">
                                              </div>
      ...
      <script>
        ...
        function fetch_rooms() {
          ...
          xhr.onprogress = function() {
            rooms_data.innerHTML=`<div class="spinner-border text-info mb-3 d-none" id="info_loader" role="status">
