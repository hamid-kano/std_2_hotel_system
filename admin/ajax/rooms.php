...
<?php
    ...
    if(isset($_POST['add_room'])){
        ...
        $valus=[$frm_data['name'],$frm_data['area'],$frm_data['price'],$frm_data['quantity'],$frm_data['adult'],$frm_data['children'],$frm_data['desc']];

        if(insert($q1,$valus,'siiiiis')){
            $flag=1;
        }
        ...
        while($row = mysqli_fetch_assoc($res)){
            ...
            $data.="
                <tr class='align-middle'>
                    ...
                    <td>$row[area]</td>
                    <td>
                        <span class='bedge rounded-pill bg-light text-dark'>
                            Adult:$row[adult]
                        </span><br>
                        <span class='bedge rounded-pill bg-light text-dark'>
    ...
    if(isset($_POST['edit_room']))
    {
        ...
        $valus=[$frm_data['name'],$frm_data['area'],$frm_data['price'],$frm_data['quantity'],$frm_data['adult'],$frm_data['children'],$frm_data['desc'],$frm_data['room_id']];

        if(update($q1,$valus,'siiiiisi')){
            $flag=1;
        }
