...
<head>
    ...
    <?php 
        ...
        $unread_queries=mysqli_fetch_assoc(mysqli_query($con,"SELECT COUNT(sr_no) AS `count` FROM `user_queries1` WHERE `seen`=0"));
        ...
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hiiden">
                ...
                <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <select class="form-select shutdown-none bg-light w-auto" onchange=booking_analytics(this.value)>
                ...
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <h5>User , Queries, Reviews</h5>

                    <select class="form-select shutdown-none bg-light w-auto" onchange=user_analytics(this.value)>
                        <option value="1">Past 30 Days</option>
                        <option value="2">Past 90 Days</option>
                        <option value="3">Past 1 Year</option>
                        <option value="5">All Time</option>
