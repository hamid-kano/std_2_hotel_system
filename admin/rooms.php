                                                ...
                                                while($opt=mysqli_fetch_assoc($res)){
                                                    echo "
                                                        <div class='col-md-3 mb-1'>
                                                            <lable>
                                                                <input type='checkbox' name='features' value='$opt[id]' class='form-chick-input shadow-none'>
                                                                $opt[name]
                                                            </label>
                                                        </div> 
                                                    "; 
                                            ...
                                            <div class="row">
                                                ...
                                                while($opt=mysqli_fetch_assoc($res)){
                                                    echo "
                                                        <div class='col-md-3 mb-1'>
                                                            <lable>
                                                                <input type='checkbox' name='facilities' value='$opt[id]' class='form-chick-input shadow-none'>
                                                                $opt[name]
                                                            </label>
                                                        </div> 
                                                    "; 
