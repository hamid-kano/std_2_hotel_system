<?php $pageTitle = 'Room Images — ' . htmlspecialchars($room['name']); ?>
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body p-4">
        <h6 class="fw-700 mb-3"><i class="fas fa-upload text-primary-custom"></i> Add Image</h6>
...
<div class="col-12 empty-state">
    ...
    <p>No images yet. Upload the first one above.</p>
</div>
<?php else: ?>
    ...
    <div class="card border-0 shadow-sm overflow-hidden">
        ...
        <div class="card-body p-2 d-flex gap-2">
            ...
            <span class="badge bg-success flex-fill text-center py-2">
                <i class="fas fa-check"></i> Thumbnail
            </span>
            <?php else: ?>
