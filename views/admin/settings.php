...
<div class="row g-4">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <h6 class="fw-700 mb-4">
                    <i class="fas fa-cog text-primary-custom"></i> General
                </h6>
    ...
    <div class="col-lg-6">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <h6 class="fw-700 mb-4">
                    <i class="fas fa-address-book text-primary-custom"></i> Contact Details
                </h6>
            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h6 class="fw-700 mb-0">
                        <i class="fas fa-users text-primary-custom"></i> Management Team
                    </h6>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 text-center text-secondary py-3">No team members yet</div>
                    <?php else: ?>
        ...
        <div class="modal-content">
            <form method="POST" action="<?php echo SITE_URL; ?>admin/settings/member/add" enctype="multipart/form-data">
                <div class="modal-header">
                    <h5 class="modal-title fw-700">Add Team Member</h5>
