...
<div class="container">
    <div class="row">
        <div class="col-12 my-5 px-4">
            <h2 class="fw-bold">
                <i class="fas fa-calendar-check" class="text-primary-custom"></i><?php echo lang('bookings'); ?>
            </h2>
        ...
        <?php
            ...
            if($data['booking_status']==='booked'){
                ...
                $btn = $data['refund']==0
                    ? "<span class='badge bg-primary'><i class='fas fa-clock'></i>Refund in Process</span>"
                    : "<a href='" . SITE_URL . "booking/pdf?id={$data['booking_id']}' class='btn btn-sm btn-dark shadow-none'><i class='fas fa-file-pdf'></i>PDF</a>";
            }
        ?>
            ...
            <div class="card border-0 shadow-sm rounded-3 h-100">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted small mb-3">
                        <i class="fas fa-moon"></i><?php echo $data['price']; ?> per night
                    </p>
                    <div class="mb-3">
                        <div class="d-flex justify-content-between mb-1">
                            <span class="text-muted small"><i class="fas fa-calendar-check"></i>Check-in</span>
                            <strong class="small"><?php echo date('d-m-Y', strtotime($data['check_in'])); ?></strong>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span class="text-muted small"><i class="fas fa-calendar-times"></i>Check-out</span>
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between mb-1">
                            <span class="text-muted small"><i class="fas fa-dollar-sign"></i>Amount</span>
                            <strong class="small"><?php echo $data['total_pay']; ?></strong>
                        </div>
                        <div class="d-flex justify-content-between mb-1">
                            <span class="text-muted small"><i class="fas fa-hashtag"></i>Order ID</span>
                            <strong class="small"><?php echo htmlspecialchars($data['order_id']); ?></strong>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span class="text-muted small"><i class="fas fa-clock"></i>Date</span>
            ...
            <form id="review-form">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="fas fa-star" class="text-primary-custom"></i>Rate & Review
                    </h5>
